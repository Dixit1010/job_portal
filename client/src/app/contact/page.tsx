  ...
  return (
    <div className="min-h-screen bg-background text-foreground py-12 sm:py-16 md:py-20 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 md:gap-16">
        <div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tighter mb-6">Let&apos;s talk.</h1>
        ...
        <div className="bg-card/30 backdrop-blur-xl border border-white/10 rounded-3xl p-4 sm:p-6 md:p-8">
          <form className="space-y-6 flex flex-col h-full">
            ...
            <div className="space-y-2 flex-grow">
              ...
              <textarea 
                id="message" 
                className="w-full h-24 sm:h-32 bg-background border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all resize-none"
