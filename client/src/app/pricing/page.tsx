  ...
  return (
    <div className="min-h-screen bg-background text-foreground py-12 sm:py-16 md:py-20 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold tracking-tighter text-center mb-4 sm:mb-6">
          Simple, transparent pricing
        </h1>
        <p className="text-base sm:text-lg text-muted-foreground text-center max-w-2xl mb-10 sm:mb-16 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 w-full max-w-4xl">
          {/* Free Tier */}
          <div className="rounded-3xl border border-white/10 bg-card/40 backdrop-blur-xl p-5 sm:p-8 flex flex-col transition-all hover:-translate-y-1 hover:border-white/20">
            ...
            <div className="mb-6">
              <span className="text-4xl sm:text-5xl font-extrabold tracking-tighter">$0</span>
          ...
          {/* Pro Tier */}
          <div className="rounded-3xl border border-primary/50 bg-primary/5 backdrop-blur-xl p-5 sm:p-8 flex flex-col relative transition-all hover:-translate-y-1 hover:border-primary">
            ...
            <div className="mb-6">
              <span className="text-4xl sm:text-5xl font-extrabold tracking-tighter">$199</span>
